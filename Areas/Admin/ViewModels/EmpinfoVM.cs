...
namespace KS_Payroll.Areas.Admin.ViewModels
{
    ...
    public class EmpinfoVM
    {
        ...
        public string  EmpMobileAcc{ get; set; }
        public string MFSnumber { get; set; }

        public IFormFile EmpPrfImg { get; set; }
        public IFormFile EmpNIDImg { get; set; }
        public IFormFile EmpBodImg { get; set; }
        public IFormFile EmpPassportImg { get; set; }
        public IFormFile EmpContractImg { get; set; }
        public IFormFile EmpSigImg { get; set; }
        ...
        //shift time details for manusal attendance
